...
// added by smiffy6969 to work out directory structure for file uploads
$rootAddress = explode('/blade_packs/', $_SERVER['PHP_SELF']);
$installPath = $rootAddress[0].'/datastore/media/';
...
$Config['UserFilesPath'] = $installPath ;
